...
<html>
  ...
  <link rel="stylesheet" type = "text/css" href ="include/css/view_food_items.css">
...
$sql = "SELECT * FROM trainee f WHERE f.R_ID IN (SELECT r.R_ID FROM institute r WHERE r.M_ID='$user_check') ORDER BY F_ID";
